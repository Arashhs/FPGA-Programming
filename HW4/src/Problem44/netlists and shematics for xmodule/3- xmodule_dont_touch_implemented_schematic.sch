...
load port out_a output -pg 1 -lvl 8 -x 1110 -y 230
load port out_b output -pg 1 -lvl 8 -x 1110 -y 380
...
load inst out_a_OBUF_inst OBUF hdi_primitives -attr @cell(#000000) OBUF -pg 1 -lvl 7 -x 960 -y 230
load inst out_a_reg FDRE hdi_primitives -attr @cell(#000000) FDRE -pg 1 -lvl 6 -x 850 -y 230
load inst out_b_OBUF_inst OBUF hdi_primitives -attr @cell(#000000) OBUF -pg 1 -lvl 7 -x 960 -y 380
load inst out_b_reg FDRE hdi_primitives -attr @cell(#000000) FDRE -pg 1 -lvl 6 -x 850 -y 380
...
load inst wire_a_inst LUT1 hdi_primitives -attr @cell(#000000) LUT1 -pg 1 -lvl 5 -x 690 -y 230
...
netloc clk_IBUF_BUFG 1 2 4 340 200 NJ 200 NJ 200 780
...
load net wire_a -pin out_a_reg D -pin wire_a_inst O
netloc wire_a 1 5 1 N 240
load net wire_b -pin out_b_reg D -pin wire_a_inferred_i_1 O -pin wire_a_inst I0
netloc wire_b 1 4 2 660 390 N
levelinfo -pg 1 0 40 180 390 540 690 850 960 1110
pagesize -pg 1 -db -bbox -sgen -90 0 1200 480
show
fullfit
#
