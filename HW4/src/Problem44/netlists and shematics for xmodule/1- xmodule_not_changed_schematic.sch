...
load port out_a output -pg 1 -lvl 7 -x 910 -y 160
load port out_b output -pg 1 -lvl 7 -x 910 -y 230
...
load inst out_a_OBUF_inst OBUF hdi_primitives -attr @cell(#000000) OBUF -pg 1 -lvl 6 -x 760 -y 160
load inst out_a_i_1 LUT2 hdi_primitives -attr @cell(#000000) LUT2 -pg 1 -lvl 4 -x 510 -y 230
load inst out_a_reg FDRE hdi_primitives -attr @cell(#000000) FDRE -pg 1 -lvl 5 -x 630 -y 230
load inst out_b_OBUF_inst OBUF hdi_primitives -attr @cell(#000000) OBUF -pg 1 -lvl 6 -x 760 -y 230
...
load net <const0> -ground -pin out_a_reg R -pin tmp_a_reg R -pin tmp_b_reg R
load net <const1> -power -pin out_a_reg CE -pin tmp_a_reg CE -pin tmp_b_reg CE
...
load net clk_IBUF_BUFG -pin clk_IBUF_BUFG_inst O -pin out_a_reg C -pin tmp_a_reg C -pin tmp_b_reg C
netloc clk_IBUF_BUFG 1 2 3 340 200 NJ 200 NJ
...
load net or_result -pin out_a_i_1 O -pin out_a_reg D
netloc or_result 1 4 1 N 240
load net out_a -port out_a -pin out_a_OBUF_inst O
netloc out_a 1 6 1 NJ 160
load net out_b -port out_b -pin out_b_OBUF_inst O
netloc out_b 1 6 1 NJ 230
load net out_b_OBUF -pin out_a_OBUF_inst I -pin out_a_reg Q -pin out_b_OBUF_inst I
netloc out_b_OBUF 1 5 1 720 160n
load net tmp_a -pin out_a_i_1 I0 -pin tmp_a_reg Q
netloc tmp_a 1 3 1 480 100n
load net tmp_b -pin out_a_i_1 I1 -pin tmp_b_reg Q
netloc tmp_b 1 3 1 480 260n
levelinfo -pg 1 0 40 180 390 510 630 760 910
pagesize -pg 1 -db -bbox -sgen -90 0 1000 400
show
fullfit
#
